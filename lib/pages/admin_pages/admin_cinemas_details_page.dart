...
import 'package:trial_one_flutter/pages/admin_pages/admin_cinema_schedule.dart';

class AdminCinemaDetailPage extends StatefulWidget {
  final Cinema cinema;

  const AdminCinemaDetailPage({this.cinema});

  @override
  _AdminCinemaDetailPageState createState() => _AdminCinemaDetailPageState();
}

class _AdminCinemaDetailPageState extends State<AdminCinemaDetailPage> {
                          ...
                          child: MaterialButton(
                            onPressed: () {
                              ...
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (context) => (AdminCinemaSchedule(
